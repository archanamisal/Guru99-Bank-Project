...
public class TestScript06 {
	...
	public Object[][] testData() {
		...
		// 1st row
		data[0][0] = TestScriptUtil06.USER_NAME;
		data[0][1] = TestScriptUtil06.PASSWD;
		//2nd row
		data[1][0] = "invalid";
		data[1][1] = "valid";
		//3rd row
	...
	public void setUp() throws Exception {
		//File pathToBinary = new File(TestScriptUtil06.FIREFOX_PATH);
		...
		baseUrl = TestScriptUtil06.BASE_URL;
		driver.manage().timeouts()
				.implicitlyWait(TestScriptUtil06.WAIT_TIME, TimeUnit.SECONDS);
	...
	public void testCase05(String username, String password) throws Exception {
		...
		driver.findElement(By.name("btnLogin")).click();
		 ...
		 try{ 
				...
				assertEquals(actualBoxMsg,TestScriptUtil06.EXPECT_ERROR);
				...
				String[] parts = pageText.split(TestScriptUtil06.PATTERN);
				String dynamicText = parts[1];

				// Check that the dynamic text is of pattern mngrXXXX
				// First 4 characters must be "mngr"
				assertTrue(dynamicText.substring(1, 5).equals(TestScriptUtil06.FIRST_PATTERN));
				...
				assertTrue(remain.matches(TestScriptUtil06.SECOND_PATTERN));
